...
const linksBtn = [
    ...
    {description: 'link orçamento', image: botao3 , link:'wa.me/5567981232612' ,last: true},
]
    ...
    <>
        <div className="section2_container">
            ...
            <div className="section2_container_cards">
                {linksBtn.map((item)=>
                        <CardLink className="section2_container_card"
                            image={item.image} 
            ...
            <div className="section2_container_feedbacks">
                ...
                <div className="section2_container_messages">
                    <img className="section2_container_feedback_mesage" src={print1} alt="print1" />
                    {/* <img className="section2_container_feedback_mesage" src={print2} alt="print1" /> */}
                </div>
